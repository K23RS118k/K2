...
private:
  ...
  double section7[4] = {20, 0.015, 0, 0.5};   //フリーエリア関数
...
//-------------------------------------------------------
  ...
  // double section0[4] = {25, 0.05, 0, 5.5};
  // double section1[4] = {20, 0.8, 0, 6.0}; //20, 0.4, 0, 6.0 カーブ1
  // double section2[4] = {15, 0.1, 0, 6.7};
  // double section5[4] = {40,  0.05, 0, 5.5};//40, 0.95, 0, 12.0 STARTからGOAL1まで
  // double section6[4] = {12, 0.015, 0, 0.5};
